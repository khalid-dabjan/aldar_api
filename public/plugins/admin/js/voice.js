...
if ("undefined" != typeof responsiveVoice) console.log("ResponsiveVoice already loaded"), console.log(responsiveVoice); else var ResponsiveVoice = function () {
    ...
    a.cache_ios_voices = [{name: "he-IL", voiceURI: "he-IL", lang: "he-IL"}, {
        ...
        voiceURI: "pt-PT",
        lang: "pt-PT"
    }, {name: "fr-FR", voiceURI: "fr-FR", lang: "fr-FR"}, {name: "ru-RU", voiceURI: "ru-RU", lang: "ru-RU"}, {
        ...
        if (a.iOS9 && !a.iOS9_initialized) console.log("Initializing ios9"), setTimeout(function () {
            ...
            if (b.length > a.CHARACTER_LIMIT) {
                for (var e = b; e.length > a.CHARACTER_LIMIT;) {
                    var g = e.search(/[:!?.;]+/), d = "";
                    if (-1 == g || g >= a.CHARACTER_LIMIT) g = e.search(/[,]+/);
                    -1 == g && -1 == e.search(" ") && (g = 99);
                    if (-1 == g || g >= a.CHARACTER_LIMIT) for (var k = e.split(" "), g = 0; g < k.length && !(d.length + k[g].length + 1 > a.CHARACTER_LIMIT); g++) d += (0 != g ? " " : "") + k[g]; else d = e.substr(0, g + 1);
            ...
            e = {};
            if (null != g.mappedProfile) e = g.mappedProfile; else if (e.systemvoice = a.getMatchedVoice(g), e.collectionvoice = {}, null == e.systemvoice) {
            ...
            for (g =
                ...
                var d = a.selectBest([e.collectionvoice.pitch, e.systemvoice.pitch, 1]),
                    ...
                    l = a.selectBest([e.collectionvoice.volume, e.systemvoice.volume, 1]), m;
    ...
    a.startTimeout = function (b, c) {
        ...
        if (!(0 >= f)) {
            var h = b.split(/\s+/).length, e = (b.match(/[^ ]/igm) || b).length,
    ...
    a.fallback_startPart = function () {
        ...
        if (null == a.fallback_audio) console.log("RV: Fallback Audio is not available"); else {
    ...
    a.mapRVs = function () {
        for (var b =
            0; b < a.responsivevoices.length; b++) for (var c = a.responsivevoices[b], f = 0; f < c.voiceIDs.length; f++) {
            var h = a.voicecollection[c.voiceIDs[f]];
            if (1 != h.fallbackvoice) {
                var e = a.getSystemVoice(h.name);
                if (null != e) {
                    c.mappedProfile = {systemvoice: e, collectionvoice: h};
                    break
                }
            } else {
    ...
    a.getSystemVoice =
        function (b) {
            ...
            for (var c = 0; c < a.systemvoices.length; c++) if (0 == a.systemvoices[c].name.localeCompare(b)) return a.systemvoices[c];
            return null
        };
    ...
    a.Dispatch = function (b) {
        ...
        var h = b + "_callbacks_timeout", e = b + "_callbacks_timeoutCount";
