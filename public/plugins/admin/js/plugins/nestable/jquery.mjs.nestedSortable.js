...
(function (factory) {
    ...
    $.widget("mjs.nestedSortable", $.extend({}, $.ui.sortable.prototype, {
        ...
        _mouseStop: function (event, noPropagation) {
            ...
            // START TFD Solution to:
            // https://github.com/ilikenwf/nestedSortable/issues/4
            ...
            */
            ...
            //if ($(this.domPosition.parent).parent().index() !== this._uiHash().item.parent().parent().index()) {
            if (pid !== this._uiHash().item.parent().parent().attr("id")) {
                isRelocated = true;
            ...
            /*
            console.log('pid: ' + pid);
            console.log('pid2: ' + $(this.domPosition.parent).parent().index());
            console.log('this._uiHash().item.parent().parent().attr("id"): ' + this._uiHash().item.parent().parent().attr("id"));
            console.log('this._uiHash().item.parent().parent().index(): ' + this._uiHash().item.parent().parent().index());
            console.log('sort: ' + sort);
            console.log('this._uiHash().item.index(): ' + this._uiHash().item.index());
            */
